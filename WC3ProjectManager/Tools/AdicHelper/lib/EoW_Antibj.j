...
define {
    ...
    <call GetLastCreatedGameCacheBJ()> = bj_lastCreatedGameCache
    ...
    <call CompareLocationsBJ(A,B)> = (A==B or (A!=null and B!=null and GetLocationX(A) == GetLocationX(B) and GetLocationY(A) == GetLocationY(B)))
